...
========================""")
    ...
    print(f"Usuario: {nombre_completo.strip().lower() [nombre_completo.strip().find(" ") + 1: ]}.{nombre_completo.strip().lower()[0:nombre_completo.strip().find(" ") + 1]}")
    ...
    print(f"Cantidad de a: {nombre_completo.strip().count('a')}")
